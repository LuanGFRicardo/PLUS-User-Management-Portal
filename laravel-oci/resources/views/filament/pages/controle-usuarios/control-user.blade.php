                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40">
                            <td class="px-4 py-2 text-sm text-gray-800 dark:text-white">João Silva</td>
                            <td class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300">joao@empresa.com</td>
                            <td class="px-4 py-2 text-sm text-gray-600 dark:text-gray-400">17/05/2025</td>
                        ...
                        {{-- Usuário Exemplo 2 --}}
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40">
                            <td class="px-4 py-2 text-sm text-gray-800 dark:text-white">Maria Oliveira</td>
                            <td class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300">maria@empresa.com</td>
                            <td class="px-4 py-2 text-sm text-gray-600 dark:text-gray-400">18/05/2025</td>
                            <td class="px-4 py-2 space-x-2">
                                <button class="px-3 py-1 text-xs font-semibold text-white bg-green-600 rounded hover:bg-green-700 transition">
                                    Aprovar
                                </button>
